  ...
  <body>
    ...
    <div class="page">
        ...
        <div class="parallax-container" data-parallax-img="images/bg-about.jpg">
          <div class="breadcrumbs-custom-body parallax-content context-dark">
            <div class="container">
              ...
              <h5 class="breadcrumbs-custom-text">At Techzoid, we offer a wide variety of laptops and other gadgets that make your life comfortable. We are always ready to supply you with the latest technology.</h5>
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid">
          ...
          <div class="slick-history">
            ...
            <div class="slick-slider carousel-parent" id="carousel-parent-2" data-items="1" data-sm-items="2" data-md-items="2" data-lg-items="3" data-xl-items="3" data-xxl-items="4" data-autoplay="false" data-loop="false">
              ...
              <div class="item">
                <div class="box-info-classic">
                  <h4 class="box-info-classic-title"> Recognition</h4>
      ...
      <section class="section section-xl bg-default">
        <div class="container">
          ...
          <div class="owl-carousel" data-items="1" data-sm-items="2" data-md-items="3" data-margin="30" data-dots="true" data-autoplay="true">
            <article class="team-classic box-md"><a class="team-classic-figure" href="#"><img src="images/team-1-370x334.jpg" alt="" width="370" height="334"/></a>
            ...
            <article class="team-classic box-md"><a class="team-classic-figure" href="#"><img src="images/team-16-370x334.jpg" alt="" width="370" height="334"/></a>
            ...
            <article class="team-classic box-md"><a class="team-classic-figure" href="#"><img src="images/team-3-370x334.jpg" alt="" width="370" height="334"/></a>
            ...
            <article class="team-classic box-md"><a class="team-classic-figure" href="#"><img src="images/team-1-370x334.jpg" alt="" width="370" height="334"/></a>
              <h4 class="team-classic-name"><a href="#">Peter Smith</a></h4>
              <p class="team-classic-text">Cum glos manducare, omnes demolitionees experientia clemens, nobilis tritic.</p>
              <ul class="list-inline team-classic-list-social list-social-2 list-inline-sm">
                <li><a class="icon mdi mdi-facebook" href="#"></a></li>
                <li><a class="icon mdi mdi-twitter" href="#"></a></li>
                <li><a class="icon mdi mdi-instagram" href="#"></a></li>
            ...
            <article class="team-classic box-md"><a class="team-classic-figure" href="#"><img src="images/team-2-370x334.jpg" alt="" width="370" height="334"/></a>
              <h4 class="team-classic-name"><a href="#">Caroline Lopez</a></h4>
              <p class="team-classic-text">Domesticus, primus mortems mechanice consumere de altus, bassus ionicis torm.</p>
              <ul class="list-inline team-classic-list-social list-social-2 list-inline-sm">
                <li><a class="icon mdi mdi-facebook" href="#"></a></li>
                <li><a class="icon mdi mdi-twitter" href="#"></a></li>
                <li><a class="icon mdi mdi-instagram" href="#"></a></li>
            ...
            <article class="team-classic box-md"><a class="team-classic-figure" href="#"><img src="images/team-17-370x334.jpg" alt="" width="370" height="334"/></a>
              <h4 class="team-classic-name"><a href="#">Will Mcmillan</a></h4>
              <p class="team-classic-text">Cum accentor experimentum, omnes torquises contactus camerarius, pius zirbuses.</p>
              <ul class="list-inline team-classic-list-social list-social-2 list-inline-sm">
                <li><a class="icon mdi mdi-facebook" href="#"></a></li>
                <li><a class="icon mdi mdi-twitter" href="#"></a></li>
                <li><a class="icon mdi mdi-instagram" href="#"></a></li>
      ...
      <section class="section section-lg bg-sky-blue">
        <div class="container">
          <div class="owl-carousel owl-style-2" data-items="2" data-sm-items="3" data-md-items="4" data-xxl-items="6" data-margin="30" data-dots="true"><a class="clients-classic" href="#"><img src="images/partner-1-163x56.png" alt="" width="163" height="56"/></a><a class="clients-classic" href="#"><img src="images/partner-2-137x40.png" alt="" width="137" height="40"/></a><a class="clients-classic" href="#"><img src="images/partner-3-163x44.png" alt="" width="163" height="44"/></a><a class="clients-classic" href="#"><img src="images/partner-4-162x40.png" alt="" width="162" height="40"/></a><a class="clients-classic" href="#"><img src="images/partner-5-150x34.png" alt="" width="150" height="34"/></a><a class="clients-classic" href="#"><img src="images/partner-6-158x37.png" alt="" width="158" height="37"/></a></div>
        </div>
      </section>
