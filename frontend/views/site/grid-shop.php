              ...
              <div class="aside row row-30 row-md-50 justify-content-md-between">
                ...
                <div class="aside-item col-sm-6 col-md-5 col-lg-12">
                  ...
                  <ul class="list-shop-filter">
                    ...
                    <li>
                      <label class="checkbox-inline">
                        <input name="input-group-radio" value="checkbox-2" type="checkbox">Laptops
                      </label><span class="list-shop-filter-number">(9)</span>
                    </li>
                    <li>
                      <label class="checkbox-inline">
                        <input name="input-group-radio" value="checkbox-3" type="checkbox">Smartphones
                      </label><span class="list-shop-filter-number">(5)</span>
                    </li>
                    <li>
                      <label class="checkbox-inline">
                        <input name="input-group-radio" value="checkbox-4" type="checkbox">Headphones
                    ...
                    <div class="col-4 col-sm-6 col-md-12">
                      ...
                      <article class="product-minimal">
                        <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                          ...
                          <div class="unit-body">
                            <p class="product-minimal-title"><a href="single-product.html">Grex T2 Headphones</a></p>
                    ...
                    <div class="col-4 col-sm-6 col-md-12">
                      ...
                      <article class="product-minimal">
                        <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                          ...
                          <div class="unit-body">
                            <p class="product-minimal-title"><a href="single-product.html">Smartex GR8</a></p>
                    ...
                    <div class="col-4 col-sm-6 col-md-12">
                      ...
                      <article class="product-minimal">
                        <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                          ...
                          <div class="unit-body">
                            <p class="product-minimal-title"><a href="single-product.html">MITO SX8 Tablet</a></p>
                ...
                <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4">
                  ...
                  <article class="product">
                    <div class="product-body">
                      ...
                      <h5 class="transform-none product-title"><a href="single-product.html">Smartex Laptop GRX1</a></h5>
                      <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4">
                  ...
                  <article class="product">
                    <div class="product-body">
                      ...
                      <h5 class="transform-none product-title"><a href="single-product.html">Smartex Laptop GT3</a></h5>
                      <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4">
                  ...
                  <article class="product">
                    <div class="product-body">
                      ...
                      <h5 class="transform-none product-title"><a href="single-product.html">Smartex GTR76</a></h5>
                      <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4">
                  ...
                  <article class="product">
                    <div class="product-body">
                      ...
                      <h5 class="transform-none product-title"><a href="single-product.html">Smartex Tablet GT1</a></h5>
                      <div class="product-price-wrap">
                ...
                <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4">
                  ...
                  <article class="product">
                    <div class="product-body">
                      ...
                      <h5 class="transform-none product-title"><a href="single-product.html">MITO uWatch Green</a></h5>
                      <div class="product-price-wrap">
